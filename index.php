    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li class="after-school">
                <a href="after-school.html">Внеклассная работа</a>
            </li>
            <li class="help">
    ...
    <div class="wrapper">
        ...
        <section class="section1">
            ...
            <div class="container1">
                ...
                <div class="left-side">
                    <h1>Средняя<br>
                    <span>общеобразовательная</span><br>
                    школа № 7</h1>
                    <img src="images/laying-kid.svg" class="laying-kid">
                    <img src="images/lines2.svg" class="lines">
                    <img src="images/lines2.svg" class="lines2">
                    <img src="images/lampkid.svg" class="lampkid">
                </div>            
        ...
        <section class="section2">
            ...
            <div class="container2">
                ...
                while ($article = mysqli_fetch_assoc($query)) {
                    ...
                    echo '<div class="date">';
                    $date = $article['date'];
                    echo DateTime::createFromFormat('Y-m-d', $date)->format('d.m.Y');
                    echo '</div>';
